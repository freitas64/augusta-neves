...
@section('content')
    ...
    <div class="col-md-10 content-box">
        ...
        <hr>
        {!! Form::open(array('route' => 'emailNewsletter.store', 'data-parsley-validate' => '', 'files' => true)) !!}

        {{Form::label('emails', 'Enviar Para')}}
        ...
        {{ Form::label('file', 'Upload de ficheiro') }}
        {{ Form::file('file') }}

        <hr>
        {{Form::label('body', 'Mensagem E-mail:')}}
